...
const BottomNav = () => {
  ...
  return (
    <>
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t shadow-lg bg-white dark:bg-[#18181A] border-gray-100 dark:border-gray-800">
        <div className="flex items-center justify-around h-16">
          ...
          <div className="relative">
            ...
            {isBottomMenuOpen && (
              <div className="absolute bottom-full right-0 mb-2 w-48 rounded-lg shadow-lg border bg-white dark:bg-[#2F2F2F] border-gray-100 dark:border-gray-700">
