            ...
            <div className="space-y-4 pb-6">
              ...
              <div className="flex gap-4">
                <span className="text-gray-600 dark:text-gray-400">
                  <strong className="text-gray-900 dark:text-gray-100">{formatNumber(user.following)}</strong> Following
                </span>
                <span className="text-gray-600 dark:text-gray-400">
                  <strong className="text-gray-900 dark:text-gray-100">{formatNumber(user.followers)}</strong> Followers
                </span>
              </div>
            </div>
          </div>
